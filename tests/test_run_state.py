...
class TestRunStateSerializationEdgeCases:
    ...
    def test_supported_schema_versions_match_released_boundary(self):
        """The support set should include all legacy released versions and the current writer."""
        released_versions = {"1.0", "1.1", "1.2", "1.3", "1.4", "1.5"}
        assert released_versions.issubset(SUPPORTED_SCHEMA_VERSIONS)
